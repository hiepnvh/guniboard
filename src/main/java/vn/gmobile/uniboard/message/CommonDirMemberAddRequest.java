...
public class CommonDirMemberAddRequest extends JsonRequest {

	/**
	 * @param jObj
	 * @throws Exception 
	 */
	public CommonDirMemberAddRequest(JSONObject jObj) throws Exception {
		super(jObj);
		if (jObj.has(JsParams.COMMON_DIR_MEMBER_ADD_REQUEST.DIR_ID)) {
			_dirId = jObj.getInt(JsParams.COMMON_DIR_MEMBER_ADD_REQUEST.DIR_ID);
		}
		JSONArray jsArr = jObj.getJSONArray(JsParams.COMMON_DIR_MEMBER_ADD_REQUEST.MEMBER_LIST);
	...
	public JsonResponse execute() {
		...
		try {
			...
			_dao.addCommonDirMember(_dirId, _set);
