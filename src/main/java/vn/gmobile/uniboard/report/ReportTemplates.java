...
public class ReportTemplates {
	...
	public static  TextFieldBuilder<String> createTextField(String label) {
		return cmp.text(label).setStyle(boldCenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT);
	}
	...
	public static String createDateField(Date date) {
