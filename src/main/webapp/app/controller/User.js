Ext.define(App.path('controller.User'), {
    ...
    showUser:function(){
    	if (App.Session.isLoggedIn()) {
            	...
            	var store2 = App.path('store.Profile');
                var view = this.getMainView().activateViewItem('ViewIndex4', function() {
                    var viewItem = Ext.create(App.path('view.ViewIndex4'));
                    return viewItem;
                 }, this).showWhats('ViewUser', App.path('view.ViewUser'), 'ViewBlank', App.path('view.ViewBlank'),store,'ViewUserDetail',App.path('view.ViewUserDetail'), 'ViewProfile', App.path('view.ViewProfile'), 'ViewBlank', App.path('view.ViewBlank'),store2,'ViewProfileDetail',App.path('view.ViewProfileDetail'));
